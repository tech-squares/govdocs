...
Tech Squares maintains a photo gallery and uses some photos for publicity purposes. (For the purposes of this policy, we include videos as photos.) Participants who do not wish to appear in photographs may inform the \href{https://www.mit.edu/~tech-squares/officers.html}{Club Photographer or Safer Dances Coordinators} (contact squares AT mit.edu or in person), who jointly maintain a list.
...
Photos taken in 2018 or later that are added to the gallery will be visible to the public. Photos taken in 2017 or earlier will default to be visible only to logged-in users.
...
Photographers should know that some of our community members prefer not to appear in photographs, and that harassing photography and similar behavior is subject to our \matchlink{safer-dances}{Safer Dances Policy}. If you plan on taking photos or videos at a Tech Squares event, we encourage you to let others know you are doing so, so that anyone who objects can let you know, and/or to check with an officer to see if anyone on the no-photographs list is present.
