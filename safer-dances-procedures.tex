...
Each Executive Committee (EC) shall designate one or two Safer Dances Coordinator(s) to be the point person (people) for this policy. A member of the EC (such as the President or Class Coordinator) is preferable, though the EC may instead appoint a club dancer with particular experience or interest in the subject.

The Safer Dances Coordinators shall generally:
\begin{itemize}
\item Be available to hear reports of violations of this policy (or concerning behavior) from club dancers and other attendees, whether in person or via email
\item Be available to speak with or informally warn those engaging in concerning behavior, on behalf of club dancers or other attendees
\item Collect reports made to other club coordinators, event organizers, etc.
...
In the case of inappropriate behavior at an event, the organizers of the event or any EC member present can impose immediate sanctions. If there is no EC member or clear event organizer present, any appointed coordinator can impose sanctions as well. If multiple potential sanctioners are present, discussing it first is encouraged if time permits but not required. The EC member or other sanctioner may inform the subject themselves, or may delegate to another person present or the MIT Campus Police.
...
\item Banning from some or all Tech Squares events until the conclusion of the investigation
    ...
    \end{itemize}
\item Relieving a club coordinator or other community member of their club duties until the conclusion of the investigation
\end{itemize}
...
\begin{itemize}
\item Formal warning/probation
\item Relieving a club coordinator or other community member of their club duties
\item Banning from some or all Tech Squares events
    ...
    \end{itemize}
\item Revocation of club dancer status
\end{itemize}
...
Records of reports and sanctions should generally be closely held. If patterns of behavior are suspected or an investigation is started, the Safer Dances Coordinators may share relevant information with select EC members, event organizers, or other coordinators. Everyone should strive at all times to respect the privacy interests, explicit and implicit, involved in the records and information they are privy to.


\section{Publication of policy}

Each class shall be informed of this policy and the reporting mechanisms early in the class (such as in the week 1 handout). New club dancers (class graduates and those directly granted the status by the EC) shall be sent this policy upon joining the club.
