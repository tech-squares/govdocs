...
\subsection{}At any time, the Executive Committee may appoint additional, non-EC \textit{directors} to assist with running the club, including but not limited to any required by the constitution or standing policies.
\subsection{}The EC shall solicit suggestions from the club for each director position at least once each year, around the beginning of their term.
\subsection{}Within a month of taking office, the incoming EC shall select and install a slate of directors. The EC is encouraged to select their directors before taking office, so that the EC and directors can take office simultaneously.
...
\section{}The managers (elected officers, deputies, and directors) may delegate tasks and appoint assistants, but are responsible for ensuring that all duties are handled, either by the managers themselves or their delegates.

\subarticle{Elected officers}

\subsection{}The President shall
\duty be responsible for all club operations
\duty oversee all other managers
\duty call and chair meetings of the club and the Executive Committee
\duty be a member of all committees
\duty appoint temporary managers as needed
...
\duty create club-related publicity, as requested by appropriate club managers
...
\subsection{}The Rooming Director shall reserve rooms and handle event registration for weekly dances and other club functions, and help other club managers with rooming-related needs.
\subsection{}The Rounds Directors shall manage the club's round dancing program.

\subarticle{Club Jobs}
\subsection{}Club dances shall be run by the managers and other club dancers.
...
\subsection{}The EC has several additional collective responsibilities. EC members should assume responsibility for some of these jobs, and the EC should appoint directors to do the other jobs.
...
\duty \textbf{Web coordinator}: updating the website when other EC members are unable or do not wish to do so themselves
\duty \textbf{Saturday dance director}: ensuring the smooth functioning of Saturday dances and that all Saturday dance jobs are handled
