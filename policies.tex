...
\newcommand{\sptimes}[2]{{\it Adopted #1. Expires #2.}}
...
\section The elected positions shall be elected in the order specified in the Constitution.
\section For each position,
...
\section The EC shall decide To graduate the class, a class member must dance club level or be expected to dance club level soon, in the view of the EC. The EC must approve the list of graduates. Attending 80\% of the class is often a sign that a class member will dance club level.
...
\duty liase with the ASA and other outside bodies as needed
...
\duty manage Tech Squares' social media presence
...
\subsection The Members-at-Large have no pre-defined tasks, but are encourage to choose specific ways to help the club during their term. Preferably, they will consider this prior to election and include their preferences in their platofrm.
...
\subsection The Rounds Coordinators shall manage Tech Squares' round dancing program.
...
\article{Adopting and Amending Standing Policies}
\sptimes{Spring 2015}{Spring 2016}
\section Standing policies may be adopted or amended by majority vote of the club.
\section Standing policies may be adopted or amended by majority vote of the EC. The EC shall inform the club of any such changes it makes to the standing policies, and no changes shall take effect until two weeks after said notification. Upon petition by 20\% of voting members of the club, or majority vote of the EC, any EC change shall be deelayed until addressed at a club meeting. Alternatively, the EC may choose to discard any change rather than bringing it to club vote.
\section Each standing policy shall have an expiration date. Unless otherwise specified, this shall be the end of the term three years after adoption or reapproval.
\section For each standing policy, early in the term that it will expire, the EC shall publicize and hold an open EC meeting to discuss the policy, any needed amendments, and whether it should be brought to a club meeting for discussion.
